                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="card card-custom bg-gray-100 gutter-b card-stretch">
                                        ...
                                        <div class="card-header border-0 bg-primary py-5">
                                            <h3 class="card-title font-weight-bolder text-white">User Stat</h3>
                                                    ...
                                                    <div class="col bg-white px-6 py-8 rounded-xl mb-7">
                                                        <span
                                                            ...
                                                            <!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/icons/Communication/Add-user.svg--><svg
                                                                ...
                                                                <b
                                                                    style="font-size:1.8em; padding:8px"><?php echo $user['package']; ?></b>
                                                            </svg>
                                                            <!--end::Svg Icon--></span> <a href="#"
                                                ...
                                                <div class="row m-0">
                                                    <div class="col bg-white px-6 py-8 rounded-xl mr-7">
                                                        <span class="svg-icon svg-icon-3x svg-icon-danger d-block my-2">
                                                            <!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/icons/Design/Layers.svg--><svg
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                                height="24px" viewBox="0 0 24 24" version="1.1">
                                                                <g stroke="none" stroke-width="1" fill="none"
                                                            ...
                                                            <b
                                                                style="font-size:1.8em; padding:8px"><?php echo counter('d',$user['email']); ?></b>
                                                            <!--end::Svg Icon--></span> <a href="#"
                                                    ...
                                                    <div class="col bg-white px-6 py-8 rounded-xl">
                                                        <span
                                                            ...
                                                            <!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/icons/Communication/Urgent-mail.svg--><svg
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                                height="24px" viewBox="0 0 24 24" version="1.1">
                                                                <g stroke="none" stroke-width="1" fill="none"
                                                            ...
                                                            <b
                                                                style="font-size:1.8em; padding:8px"><?php echo counter('w',$user['email']); ?></b>
                                                            <!--end::Svg Icon--></span> <a href="#"
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        ...
                                        <div class="card-header border-0 pt-5">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label font-weight-bolder text-dark">Crypto
                                                    assets</span>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        ...
                                        <div class="card-header border-0 pt-5">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span
                                                    class="card-label font-weight-bolder text-dark">Transactions</span>
                                                <span
                                                    class="text-muted mt-3 font-weight-bold font-size-sm"><?php echo mysqli_num_rows(mysqli_query($db,"select * from trans where user='".$user['email']."' ")); ?></span>
                                            </h3>
                                        ...
                                        <div class="card-body pt-2 pb-0">
                                            ...
                                            <div class="table-responsive">
                                                <table
                                                    class="table table-borderless table-stripped table-vertical-center">
                                                    <thead>
                                                        <tr>
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        ...
                                        <div class="card-header border-0 pt-5">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label font-weight-bolder text-dark">Live Trading </span>
                                                
                                            </h3>
                                            <div class="card-toolbar">
                                            <span class="text-muted mt-3 font-weight-bold font-size-sm">
                                                    <?php echo rand(20,700); ?>+ activae trade</span>
                                            </div>
                                        </div>
                                        <!--end::Header-->
                                                ...
                                                <table class="table table-borderless table-vertical-center">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <span class="symbol-label">
                                                                        <span
                                                                            ...
                                                                            <!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/icons/Media/Play.svg--><svg
                                                                                xmlns="http://www.w3.org/2000/svg"
                                                            ...
                                                            <td class="pl-0">
                                                                <a href="#"
                                                                    class="text-dark font-weight-bolder text-hover-primary d-block my-1 font-size-lg">$<?php echo $amtX[rand(0,16)]; ?>.00</a>
                                                                <span class="text-muted font-weight-bold"><?php echo $nameX[rand(0,26)]; ?></span>
                                                            </td>
                                                            <td class="text-right">
                                                                <span
                                                                    class="text-muted font-weight-bold mt-2 d-block font-size-xs">
                                                                    0.<?php echo $amtX[rand(0,21)]; ?>btc
                                                                </span>
                                                                <span class="text-dark-75 font-weight-bold">
                                                                <?php echo $timeX[rand(0,16)]; ?> hours ago
                                                                </span>
                                                            </td>
                                                            <td class="text-right">
                                                            <?php $xs = rand(0,2); ?>
                                                                <span
                                                                    class="font-weight-bolder text-<?php echo $colX[$xs]; ?> mt-4 d-block">
                                                                    <?php echo $statX[$xs]; ?>
                                                                </span>
                                                            </td>
