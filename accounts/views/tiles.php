...
<!-- Mirrored from keenthemes.com/metronic/preview/demo7/features/widgets/tiles.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Jun 2020 15:53:14 GMT -->
<!-- Added by HTTrack -->
<meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->

<head>
    <meta charset="utf-8" />
    <title>Metronic | Tiles Widgets</title>
    ...
    <link href="themes/metronic/theme/html/demo7/dist/assets/plugins/global/plugins.bundle7a4a.css?v=7.0.4"
        rel="stylesheet" type="text/css" />
    <link href="themes/metronic/theme/html/demo7/dist/assets/plugins/custom/prismjs/prismjs.bundle7a4a.css?v=7.0.4"
        rel="stylesheet" type="text/css" />
    <link href="themes/metronic/theme/html/demo7/dist/assets/css/style.bundle7a4a.css?v=7.0.4" rel="stylesheet"
        type="text/css" />
    ...
    <link rel="shortcut icon"
        href="https://keenthemes.com/metronic/themes/metronic/theme/html/demo7/dist/assets/media/logos/favicon.ico" />
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled page-loading">
    ...
    <div id="kt_header_mobile" class="header-mobile bg-primary  header-mobile-fixed ">
        <!--begin::Logo-->
        <a href="index-2.html">
            <img alt="Logo" src="themes/metronic/theme/html/demo7/dist/assets/media/logos/logo-letter-9.png"
                class="max-h-30px" />
        </a>
        <!--end::Logo-->
                        ...
                        <div class=" container ">
                            ...
                            <div class="d-none d-lg-flex align-items-center mr-3">
                                ...
                                <a href="index-2.html" class="mr-20">
                                    <img alt="Logo"
                                        src="themes/metronic/theme/html/demo7/dist/assets/media/logos/logo-letter-9.png"
                                        class="max-h-35px" />
                                </a>
                                <!--end::Logo-->
                            ...
                            <div class="topbar bg-primary">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                                        <div
                                            ...
                                            <span class="svg-icon svg-icon-xl">
                                                <!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/icons/Code/Compiling.svg--><svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                    height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    <div
                                        ...
                                        <form>
                                            ...
                                            <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top"
                                                style="background-image: url(themes/metronic/theme/html/demo7/dist/assets/media/misc/bg-1.jpg)">
                                                <!--begin::Title-->
                                                            ...
                                                            <div class="symbol symbol-40 symbol-light-warning mr-5">
                                                                <span class="symbol-label">
                                                                    <span class="svg-icon svg-icon-lg svg-icon-warning">
                                                                        <!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/icons/Communication/Write.svg--><svg
                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                            xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                            width="24px" height="24px"
                                                                            viewBox="0 0 24 24" version="1.1">
                                                            ...
                                                            <div class="symbol symbol-40 symbol-light-success mr-5">
                                                                <span class="symbol-label">
                                                                    <span class="svg-icon svg-icon-lg svg-icon-success">
                                                                        <!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/icons/Communication/Group-chat.svg--><svg
                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                            xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                            width="24px" height="24px"
                                                                            viewBox="0 0 24 24" version="1.1">
                                                            ...
                                                            <div class="symbol symbol-40 symbol-light-danger mr-5">
                                                                <span class="symbol-label">
                                                                    <span class="svg-icon svg-icon-lg svg-icon-danger">
                                                                        <!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/icons/General/Attachment2.svg--><svg
                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                            xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                            width="24px" height="24px"
                                                                            viewBox="0 0 24 24" version="1.1">
                                                            ...
                                                            <div class="symbol symbol-40 symbol-light-info mr-5">
                                                                <span class="symbol-label">
                                                                    <span class="svg-icon svg-icon-lg  svg-icon-info">
                                                                        <!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/icons/Communication/Shield-user.svg--><svg
                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                            xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                            width="24px" height="24px"
                                                                            viewBox="0 0 24 24" version="1.1">
                                                            ...
                                                            <div class="symbol symbol-40 symbol-light-success mr-5">
                                                                <span class="symbol-label">
                                                                    <span
                                                                        ...
                                                                        <!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/icons/Design/Bucket.svg--><svg
                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                            xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                            width="24px" height="24px"
                                                                            viewBox="0 0 24 24" version="1.1">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                                        <div class="btn btn-icon btn-hover-transparent-white btn-dropdown btn-lg mr-1">
                                            <span class="svg-icon svg-icon-xl">
                                                <!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/icons/Media/Equalizer.svg--><svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                    height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        ...
                                        <div class="row row-paddingless">
                                            ...
                                            <div class="col-6">
                                                <a href="#"
                                                    ...
                                                    <span class="svg-icon svg-icon-3x svg-icon-success">
                                                        <!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/icons/Shopping/Euro.svg--><svg
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                            height="24px" viewBox="0 0 24 24" version="1.1">
                                                            <g stroke="none" stroke-width="1" fill="none"
                                            ...
                                            <div class="col-6">
                                                <a href="#"
                                                    ...
                                                    <span class="svg-icon svg-icon-3x svg-icon-success">
                                                        <!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/icons/Communication/Mail-attachment.svg--><svg
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                            height="24px" viewBox="0 0 24 24" version="1.1">
                                                            <g stroke="none" stroke-width="1" fill="none"
                                            ...
                                            <div class="col-6">
                                                <a href="#"
                                                    ...
                                                    <span class="svg-icon svg-icon-3x svg-icon-success">
                                                        <!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/icons/Shopping/Box2.svg--><svg
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                            height="24px" viewBox="0 0 24 24" version="1.1">
                                                            <g stroke="none" stroke-width="1" fill="none"
                                            ...
                                            <div class="col-6">
                                                <a href="#" class="d-block py-10 px-5 text-center bg-hover-light">
                                                    <span class="svg-icon svg-icon-3x svg-icon-success">
                                                        <!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/icons/Communication/Group.svg--><svg
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                            height="24px" viewBox="0 0 24 24" version="1.1">
                                                            <g stroke="none" stroke-width="1" fill="none"
                                        ...
                                        <form>
                                            ...
                                            <div class="scroll scroll-push" data-scroll="true" data-height="250"
                                                ...
                                                <div class="d-flex align-items-center justify-content-between p-8">
                                                    <div class="d-flex flex-column mr-2">
                                                        ...
                                                        <div class="d-flex align-items-center mt-2">
                                                            <span
                                                                class="font-weight-bold mr-1 text-dark-75 font-size-lg">$
                                                                350</span>
                                                    ...
                                                    <a href="#" class="symbol symbol-70 flex-shrink-0">
                                                        <img src="themes/metronic/theme/html/demo7/dist/assets/media/stock-600x400/img-1.jpg"
                                                            title="" alt="" />
                                                    </a>
                                                </div>
                                                <!--end::Item-->
                                                ...
                                                <div class="d-flex align-items-center justify-content-between p-8">
                                                    ...
                                                    <a href="#" class="symbol symbol-70 flex-shrink-0">
                                                        <img src="themes/metronic/theme/html/demo7/dist/assets/media/stock-600x400/img-2.jpg"
                                                            title="" alt="" />
                                                    </a>
                                                </div>
                                                <!--end::Item-->
                                                ...
                                                <div class="d-flex align-items-center justify-content-between p-8">
                                                    ...
                                                    <a href="#" class="symbol symbol-70 flex-shrink-0">
                                                        <img src="themes/metronic/theme/html/demo7/dist/assets/media/stock-600x400/img-3.jpg"
                                                            title="" alt="" />
                                                    </a>
                                                </div>
                                                <!--end::Item-->
                                                ...
                                                <div class="d-flex align-items-center justify-content-between p-8">
                                                    ...
                                                    <a href="#" class="symbol symbol-70 flex-shrink-0">
                                                        <img src="themes/metronic/theme/html/demo7/dist/assets/media/stock-600x400/img-4.jpg"
                                                            title="" alt="" />
                                                    </a>
                                                </div>
                                                <!--end::Item-->
                                            ...
                                            <div class="p-8">
                                                <div class="d-flex align-items-center justify-content-between mb-4">
                                                    <span
                                                        class="font-weight-bold text-muted font-size-sm mr-2">Total</span>
                                                    <span
                                                        class="font-weight-bolder text-dark-50 text-right">$1840.00</span>
                                                </div>
                                                <div class="d-flex align-items-center justify-content-between mb-7">
                                                    <span class="font-weight-bold text-muted font-size-sm mr-2">Sub
                                                        total</span>
                                                    <span
                                                        class="font-weight-bolder text-primary text-right">$5640.00</span>
                                                </div>
                                ...
                                <div class="topbar-item">
                                    <div class="btn btn-icon btn-hover-transparent-white btn-lg mr-1"
                                        ...
                                        <span class="svg-icon svg-icon-xl">
                                            <!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/icons/Layout/Layout-4-blocks.svg--><svg
                                                xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane py-5 p-lg-0 show active" id="kt_header_tab_1">
                                        ...
                                        <div id="kt_header_menu"
                                            ...
                                            <!--begin::Nav-->
                                            <ul class="menu-nav ">
                                                <li class="menu-item " aria-haspopup="true"><a href="index-2.html"
                                                ...
                                                <li class="menu-item  menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here"
                                                    data-menu-toggle="click" aria-haspopup="true"><a href="javascript:;"
                                                        class="menu-link menu-toggle"><span
                                                            class="menu-text">Features</span><span
                                                            ...
                                                            <li class="menu-item  menu-item-submenu"
                                                                data-menu-toggle="hover" aria-haspopup="true"><a
                                                                    ...
                                                                    class="menu-link menu-toggle"><span
                                                                        ...
                                                                        <!--end::Svg Icon--></span><span
                                                                        class="menu-text">Bootstrap</span><i
                                                                ...
                                                                <div
                                                                    ...
                                                                    <ul class="menu-subnav">
                                                                        ...
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="bootstrap/button-group.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                        ...
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                ...
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Dropdown</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="bootstrap/navs.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Navs</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="bootstrap/tables.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                        ...
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                ...
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Modal</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="bootstrap/alerts.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Alerts</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="bootstrap/popover.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Popover</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="bootstrap/tooltip.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Tooltip</span></a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </li>
                                                            <li class="menu-item  menu-item-submenu"
                                                                data-menu-toggle="hover" aria-haspopup="true"><a
                                                                    ...
                                                                    class="menu-link menu-toggle"><span
                                                                        ...
                                                                        <!--end::Svg Icon--></span><span
                                                                        class="menu-text">Custom</span><i
                                                                        class="menu-arrow"></i></a>
                                                                <div
                                                                    class="menu-submenu menu-submenu-classic menu-submenu-right">
                                                                    <ul class="menu-subnav">
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="custom/utilities.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Utilities</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="custom/accordions.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Accordions</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="custom/label.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Label</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="custom/pulse.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Pulse</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="custom/line-tabs.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Line
                                                                                    Tabs</span></a></li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="custom/advance-navs.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Advance
                                                                                    Navigations</span></a></li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="custom/timeline.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Timeline</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="custom/pagination.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Pagination</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="custom/symbol.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Symbol</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="custom/spinners.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Spinners</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="custom/iconbox.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Iconbox</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="custom/callout.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Callout</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="custom/ribbons.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                            ...
                                                            <li class="menu-item  menu-item-submenu"
                                                                data-menu-toggle="hover" aria-haspopup="true"><a
                                                                    ...
                                                                    class="menu-link menu-toggle"><span
                                                                        ...
                                                                        <!--end::Svg Icon--></span><span
                                                                        class="menu-text">Icons</span><i
                                                                        class="menu-arrow"></i></a>
                                                                <div
                                                                    class="menu-submenu menu-submenu-classic menu-submenu-right">
                                                                    <ul class="menu-subnav">
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="icons/flaticon.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Flaticon</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="icons/fontawesome5.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Fontawesome
                                                                                    5</span></a></li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                        ...
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="icons/socicons.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Socicons</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="icons/svg.html"
                                                                                class="menu-link "><i
                                                                                    ...
                                                                                    Icons</span></a></li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="icons/keenthemes-icons.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                            ...
                                                            <li class="menu-item  menu-item-submenu"
                                                                data-menu-toggle="hover" aria-haspopup="true"><a
                                                                    ...
                                                                    class="menu-link menu-toggle"><span
                                                                        ...
                                                                        <!--end::Svg Icon--></span><span
                                                                        class="menu-text">Cards</span><i
                                                                        class="menu-arrow"></i></a>
                                                                <div
                                                                    class="menu-submenu menu-submenu-classic menu-submenu-right">
                                                                    <ul class="menu-subnav">
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="cards/general.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">General
                                                                                    Cards</span></a></li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="cards/stacked.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Stacked
                                                                                    Cards</span></a></li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="cards/tabbed.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Tabbed
                                                                                    Cards</span></a></li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="cards/draggable.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Draggable
                                                                                    Cards</span></a></li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="cards/tools.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Cards
                                                                                    Tools</span></a></li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="cards/sticky.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Sticky
                                                                                    Cards</span></a></li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="cards/stretched.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Stretched
                                                                                    Cards</span></a></li>
                                                                    </ul>
                                                                </div>
                                                            </li>
                                                            <li class="menu-item  menu-item-open menu-item-here menu-item-submenu"
                                                                data-menu-toggle="hover" aria-haspopup="true"><a
                                                                    ...
                                                                    class="menu-link menu-toggle"><span
                                                                        ...
                                                                        <!--end::Svg Icon--></span><span
                                                                        class="menu-text">Widgets</span><i
                                                                        class="menu-arrow"></i></a>
                                                                <div
                                                                    class="menu-submenu menu-submenu-classic menu-submenu-right">
                                                                    <ul class="menu-subnav">
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="lists.html" class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Lists</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="stats.html" class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Stats</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="charts.html" class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Charts</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="charts.html" class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                        ...
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="mixed.html" class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Mixed</span></a>
                                                                        </li>
                                                                        <li class="menu-item  menu-item-active "
                                                                            aria-haspopup="true"><a href="tiles.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Tiles</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="engage.html" class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Engage</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                        ...
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                ...
                                                                                class="menu-link "><i
                                                                                    ...
                                                                                    Tables</span></a></li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="forms.html" class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                            ...
                                                            <li class="menu-item  menu-item-submenu"
                                                                data-menu-toggle="hover" aria-haspopup="true"><a
                                                                    ...
                                                                    class="menu-link menu-toggle"><span
                                                                        ...
                                                                        <!--end::Svg Icon--></span><span
                                                                        class="menu-text">Calendar</span><i
                                                                        class="menu-arrow"></i></a>
                                                                <div
                                                                    class="menu-submenu menu-submenu-classic menu-submenu-right">
                                                                    <ul class="menu-subnav">
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                ...
                                                                                class="menu-link "><i
                                                                                    ...
                                                                                    Calendar</span></a></li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="calendar/list-view.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">List
                                                                                    Views</span></a></li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="calendar/google.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                        ...
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                ...
                                                                                class="menu-link "><i
                                                                                    ...
                                                                                    Events</span></a></li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="calendar/background-events.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                ...
                                                                <div
                                                                    ...
                                                                    <ul class="menu-subnav">
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                ...
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Apexcharts</span></a>
                                                                        </li>
                                                                        <li class="menu-item  menu-item-submenu"
                                                                                ...
                                                                                <ul class="menu-subnav">
                                                                                    <li class="menu-item "
                                                                                        aria-haspopup="true"><a
                                                                                            href="charts/amcharts/charts.html"
                                                                                            class="menu-link "><i
                                                                                                class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    ...
                                                                                    <li class="menu-item "
                                                                                        aria-haspopup="true"><a
                                                                                            href="charts/amcharts/stock-charts.html"
                                                                                            class="menu-link "><i
                                                                                                class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                                class="menu-text">amCharts
                                                                                                Stock Charts</span></a>
                                                                                    ...
                                                                                    <li class="menu-item "
                                                                                        aria-haspopup="true"><a
                                                                                            href="charts/amcharts/maps.html"
                                                                                            class="menu-link "><i
                                                                                                class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                                class="menu-text">amCharts
                                                                                                Maps</span></a></li>
                                                                        ...
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                ...
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Flot
                                                                                    Charts</span></a></li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="charts/google-charts.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Google
                                                                                    Charts</span></a></li>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <ul class="menu-subnav">
                                                                        ...
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                ...
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Leaflet</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="maps/jqvmap.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">JQVMap</span></a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </li>
                                                            <li class="menu-item  menu-item-submenu"
                                                                data-menu-toggle="hover" aria-haspopup="true"><a
                                                                    ...
                                                                    class="menu-link menu-toggle"><span
                                                                        ...
                                                                        <!--end::Svg Icon--></span><span
                                                                        class="menu-text">Miscellaneous</span><i
                                                                        class="menu-arrow"></i></a>
                                                                <div class="menu-submenu menu-submenu-classic menu-submenu-right"
                                                                    style="top: -150px">
                                                                    <ul class="menu-subnav">
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="miscellaneous/kanban-board.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Kanban
                                                                                    Board</span></a></li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="miscellaneous/sticky-panels.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Sticky
                                                                                    Panels</span></a></li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="miscellaneous/blockui.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Block
                                                                                    UI</span></a></li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="miscellaneous/perfect-scrollbar.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Perfect
                                                                                    Scrollbar</span></a></li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="miscellaneous/treeview.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Tree
                                                                                    View</span></a></li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="miscellaneous/bootstrap-notify.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Bootstrap
                                                                                    Notify</span></a></li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="miscellaneous/toastr.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Toastr</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="miscellaneous/sweetalert2.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">SweetAlert2</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="miscellaneous/dual-listbox.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Dual
                                                                                    Listbox</span></a></li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="miscellaneous/session-timeout.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Session
                                                                                    Timeout</span></a></li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="miscellaneous/idle-timer.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Idle
                                                                                    Timer</span></a></li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="miscellaneous/cropper.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Cropper</span></a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </li>
                                                            <li class="menu-item " aria-haspopup="true"><a
                                                                    href="builder.html" class="menu-link "><span
                                                                        class="svg-icon menu-icon">
                                                                        ...
                                                                        <!--end::Svg Icon--></span><span
                                                                        class="menu-text">Layout Builder</span></a></li>
                                                        </ul>
                                                    </div>
                                                </li>
                                                <li class="menu-item  menu-item-submenu menu-item-rel"
                                                    data-menu-toggle="click" aria-haspopup="true"><a href="javascript:;"
                                                        class="menu-link menu-toggle"><span
                                                            class="menu-text">Crud</span><span
                                                            class="menu-desc"></span><i class="menu-arrow"></i></a>
                                                    <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                                        <ul class="menu-subnav">
                                                            <li class="menu-item  menu-item-submenu"
                                                                data-menu-toggle="hover" aria-haspopup="true"><a
                                                                    ...
                                                                    class="menu-link menu-toggle"><span
                                                                        ...
                                                                        <!--end::Svg Icon--></span><span
                                                                        class="menu-text">Forms & Controls</span><i
                                                                        class="menu-arrow"></i></a>
                                                                <div
                                                                    class="menu-submenu menu-submenu-classic menu-submenu-right">
                                                                    <ul class="menu-subnav">
                                                            ...
                                                            <li class="menu-item  menu-item-submenu"
                                                                data-menu-toggle="hover" aria-haspopup="true"><a
                                                                    ...
                                                                    class="menu-link menu-toggle"><span
                                                                        ...
                                                                        <!--end::Svg Icon--></span><span
                                                                        class="menu-text">KTDatatable</span><i
                                                                        class="menu-arrow"></i></a>
                                                                <div
                                                                    class="menu-submenu menu-submenu-classic menu-submenu-right">
                                                                    <ul class="menu-subnav">
                                                            ...
                                                            <li class="menu-item  menu-item-submenu"
                                                                data-menu-toggle="hover" aria-haspopup="true"><a
                                                                    ...
                                                                    class="menu-link menu-toggle"><span
                                                                        ...
                                                                        <!--end::Svg Icon--></span><span
                                                                        class="menu-text">Datatables.net</span><i
                                                                        class="menu-arrow"></i></a>
                                                                <div
                                                                    class="menu-submenu menu-submenu-classic menu-submenu-right">
                                                                    <ul class="menu-subnav">
                                                            ...
                                                            <li class="menu-item  menu-item-submenu"
                                                                data-menu-toggle="hover" aria-haspopup="true"><a
                                                                    ...
                                                                    class="menu-link menu-toggle"><span
                                                                        ...
                                                                        <!--end::Svg Icon--></span><span
                                                                        class="menu-text">File Upload</span><i
                                                                        class="menu-arrow"></i></a>
                                                                <div
                                                                    class="menu-submenu menu-submenu-classic menu-submenu-right">
                                                                    <ul class="menu-subnav">
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                ...
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Image
                                                                                    Input</span></a></li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="crud/file-upload/dropzonejs.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">DropzoneJS</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="crud/file-upload/uppy.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Uppy</span></a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </li>
                                                        ...
                                                        <ul class="menu-subnav">
                                                            ...
                                                            <li class="menu-item  menu-item-submenu"
                                                                data-menu-toggle="hover" aria-haspopup="true"><a
                                                                    ...
                                                                    class="menu-link menu-toggle"><span
                                                                        ...
                                                                        <!--end::Svg Icon--></span><span
                                                                        class="menu-text">Profile</span><i
                                                                        class="menu-arrow"></i></a>
                                                                <div
                                                                    class="menu-submenu menu-submenu-classic menu-submenu-right">
                                                                    <ul class="menu-subnav">
                                                            ...
                                                            <li class="menu-item  menu-item-submenu"
                                                                data-menu-toggle="hover" aria-haspopup="true"><a
                                                                    ...
                                                                    class="menu-link menu-toggle"><span
                                                                        ...
                                                                        <!--end::Svg Icon--></span><span
                                                                        class="menu-text">Contacts</span><i
                                                                        class="menu-arrow"></i></a>
                                                                <div
                                                                    class="menu-submenu menu-submenu-classic menu-submenu-right">
                                                                    <ul class="menu-subnav">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <ul class="menu-subnav">
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                ...
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Private</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="custom/apps/chat/group.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Group</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="custom/apps/chat/popup.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Popup</span></a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </li>
                                                            <li class="menu-item  menu-item-submenu"
                                                                data-menu-toggle="hover" aria-haspopup="true"><a
                                                                    ...
                                                                    class="menu-link menu-toggle"><span
                                                                        ...
                                                                        <!--end::Svg Icon--></span><span
                                                                        class="menu-text">Projects</span><i
                                                                        class="menu-arrow"></i></a>
                                                                <div
                                                                    class="menu-submenu menu-submenu-classic menu-submenu-right">
                                                                    <ul class="menu-subnav">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <ul class="menu-subnav">
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                ...
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Tasks</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="custom/apps/todo/docs.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Docs</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="custom/apps/todo/files.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                                    class="menu-text">Files</span></a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </li>
                                                            <li class="menu-item " aria-haspopup="true"><a
                                                                    ...
                                                                    class="menu-link "><span class="svg-icon menu-icon">
                                                                        ...
                                                                        <!--end::Svg Icon--></span><span
                                                                        class="menu-text">Inbox</span><span
                                                ...
                                                <li class="menu-item  menu-item-submenu" data-menu-toggle="click"
                                                    aria-haspopup="true"><a href="javascript:;"
                                                        class="menu-link menu-toggle"><span
                                                            class="menu-text">Pages</span><span
                                                            class="menu-desc"></span><i class="menu-arrow"></i></a>
                                                                ...
                                                                <li class="menu-item ">
                                                                    ...
                                                                    <ul class="menu-inner">
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                ...
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-line"><span></span></i><span
                                                                                    class="menu-text">Login 1</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="custom/pages/login/login-2.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-line"><span></span></i><span
                                                                                    class="menu-text">Login 2</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="custom/pages/login/login-3/signup.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-line"><span></span></i><span
                                                                                    class="menu-text">Login
                                                                                    3</span><span
                                                                                    class="menu-label"><span
                                                                ...
                                                                <li class="menu-item ">
                                                                    ...
                                                                    <ul class="menu-inner">
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                ...
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-line"><span></span></i><span
                                                                                    class="menu-text">Error 1</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="custom/pages/error/error-2.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-line"><span></span></i><span
                                                                                    class="menu-text">Error 2</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="custom/pages/error/error-3.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-line"><span></span></i><span
                                                                                    class="menu-text">Error 3</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="custom/pages/error/error-4.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-line"><span></span></i><span
                                                                                    class="menu-text">Error 4</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="custom/pages/error/error-5.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-line"><span></span></i><span
                                                                                    class="menu-text">Error 5</span></a>
                                                                        </li>
                                                                        <li class="menu-item " aria-haspopup="true"><a
                                                                                href="custom/pages/error/error-6.html"
                                                                                class="menu-link "><i
                                                                                    class="menu-bullet menu-bullet-line"><span></span></i><span
                                                                                    class="menu-text">Error 6</span></a>
                                                                        </li>
                                                                    </ul>
                                                                </li>
                                                            </ul>
                                ...
                                <div class="dropdown dropdown-inline" data-toggle="tooltip" title="Quick actions"
                                    ...
                                    <a href="#" class="btn btn-icon" data-toggle="dropdown" aria-haspopup="true"
                                        ...
                                        <span class="svg-icon svg-icon-success svg-icon-2x">
                                            <!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/icons/Files/File-plus.svg--><svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                                viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <div class="row">
                                <div class="col-xl-4">
                                    ...
                                    <div class="card card-custom gutter-b card-stretch">
                                        ...
                                        <div class="card-body d-flex flex-column px-0">
                                            <!--begin::Chart-->
                                            <div id="kt_tiles_widget_1_chart" data-color="info" style="height: 150px">
                                            </div>
                                            <!--end::Chart-->
                                            ...
                                            <div class="flex-grow-1 card-spacer-x">
                                                    ...
                                                    <div class="d-flex align-items-center mr-2">
                                                        <div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
                                                            <div class="symbol-label">
                                                                <img src="https://keenthemes.com/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/misc/006-plurk.svg"
                                                                    alt="" class="h-50" />
                                                            </div>
                                                        </div>
                                                        <div>
                                                ...
                                                <div class="d-flex align-items-center justify-content-between mb-10">
                                                    <div class="d-flex align-items-center mr-2">
                                                        <div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
                                                            <div class="symbol-label">
                                                                <img src="https://keenthemes.com/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/misc/015-telegram.svg"
                                                                    alt="" class="h-50" />
                                                            </div>
                                                        </div>
                                                        <div>
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div class="d-flex align-items-center mr-2">
                                                        <div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
                                                            <div class="symbol-label">
                                                                <img src="https://keenthemes.com/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/misc/003-puzzle.svg"
                                                                    alt="" class="h-50" />
                                                            </div>
                                                        </div>
                                                        <div>
                                ...
                                <div class="col-xl-5">
                                    <div class="row">
                                        <div class="col-xl-6">
                                            ...
                                            <div class="card card-custom bgi-no-repeat bgi-no-repeat bgi-size-cover gutter-b"
                                                style="height: 175px; background-image: url(themes/metronic/theme/html/demo7/dist/assets/media/bg/bg-9.jpg)">
                                                <!--begin::Body-->
                                    ...
                                    <div class="card card-custom bgi-no-repeat gutter-b"
                                        style="height: 180px; background-color: #4AB58E; background-position: calc(100% + 0.5rem) bottom; background-size: 25% auto; background-image: url(https://keenthemes.com/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/humans/custom-1.svg)">
                                        <!--begin::Body-->
                                ...
                                <div class="col-xl-3">
                                    ...
                                    <div class="card card-custom bgi-no-repeat gutter-b card-stretch"
                                        style="background-color: #1B283F; background-position: calc(100% + 0.5rem) calc(100% + 0.5rem); background-size: 90% auto; background-image: url(https://keenthemes.com/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/patterns/rhone.svg)">
                                        <!--begin::Body-->
                                        <div class="card-body">
                                            <div class="p-4">
                                        ...
                                        <div class="card-body d-flex flex-column p-0">
                                            ...
                                            <div class="flex-grow-1 card-spacer">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between mb-10">
                                                    <div class="d-flex align-items-center mr-2">
                                                        <div
                                                            class="symbol symbol-40 symbol-light-primary mr-3 flex-shrink-0">
                                                            <div class="symbol-label">
                                                                <span class="svg-icon svg-icon-lg svg-icon-primary">
                                                                    <!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/icons/Home/Library.svg--><svg
                                                                        xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <div class="d-flex align-items-center justify-content-between mb-10">
                                                    <div class="d-flex align-items-center mr-2">
                                                        <div
                                                            ...
                                                            <div class="symbol-label">
                                                                <span class="svg-icon svg-icon-lg svg-icon-warning">
                                                                    <!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/icons/Devices/Mic.svg--><svg
                                                                        xmlns="http://www.w3.org/2000/svg"
                                                                        xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                        width="24px" height="24px" viewBox="0 0 24 24"
                                                                        version="1.1">
                                            ...
                                            <!--begin::Chart-->
                                            <div id="kt_tiles_widget_8_chart" class="card-rounded-bottom"
                                ...
                                <div class="col-xl-8">
                                    <div class="row">
                                        <div class="col-xl-3">
                                            ...
                                            <div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b"
                                                style="height: 150px; background-image: url(themes/metronic/theme/html/demo7/dist/assets/media/stock-600x400/img-26.jpg)">
                                                <!--begin::Body-->
                                                <div class="card-body d-flex flex-column">
                                                    <!--begin::Title-->
                                                    <a href="#"
                                        ...
                                        <div class="col-xl-9">
                                            ...
                                            <div class="card card-custom gutter-b" style="height: 150px">
                                                ...
                                                <div
                                                    ...
                                                    <a href="#" class="btn btn-primary font-weight-bold py-3 px-6">Start
                                                        Now</a>
                                                </div>
                                                <!--end::Body-->
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6">
                                            ...
                                            <div class="card card-custom bgi-no-repeat gutter-b"
                                                style="height: 225px; background-color: #663259; background-position: calc(100% + 0.5rem) 100%; background-size: 100% auto; background-image: url(https://keenthemes.com/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/patterns/taieri.svg)">
                                                ...
                                                <div class="card-body d-flex align-items-center">
                                                    <div>
                                                        ...
                                                        <a href='#'
                                                            class="btn btn-success font-weight-bold px-6 py-3">Create
                                                            Report</a>
                                                    </div>
                                                </div>
                                                <!--end::Body-->
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b card-stretch"
                                                style="background-image: url(themes/metronic/theme/html/demo7/dist/assets/media/stock-600x600/img-16.jpg)">
                                                <!--begin::Body-->
                                                <div
                                                    ...
                                                    <a href='#' class="btn btn-link btn-link-warning font-weight-bold">
                                                        Create Report
                                                        <span class="svg-icon svg-icon-lg svg-icon-warning">
                                                            <!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/icons/Navigation/Arrow-right.svg--><svg
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                                height="24px" viewBox="0 0 24 24" version="1.1">
                                                                <g stroke="none" stroke-width="1" fill="none"
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div class="d-flex align-items-center mr-2">
                                                        <div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
                                                            <div class="symbol-label">
                                                                <img src="https://keenthemes.com/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/misc/009-hot-air-balloon.svg"
                                                                    alt="" class="h-50" />
                                                            </div>
                                                        </div>
                                                        <div>
                                ...
                                <div class="col-xl-8">
                                    <div class="row">
                                        <div class="col-xl-4">
                                            ...
                                            <div class="card card-custom bgi-no-repeat gutter-b"
                                                style="height: 300px; background-color: #663259; background-position: calc(100% + 0.5rem) calc(100% + 0.5rem); background-size: 105% auto; background-image: url(https://keenthemes.com/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/patterns/aare.svg)">
                                                <!--begin::Body-->
                                                <div class="card-body">
                                                    <a href="#"
                                                        class="text-white font-weight-bolder line-height-lg mb-5 font-size-h3">Create
                                                        Reports<br />With SaaS</a>
                                                </div>
                                                <!--end::Body-->
                                            </div>
                                            <!--end::Mixed Widget 16-->
                                        ...
                                        <div class="col-xl-4">
                                            ...
                                            <div class="card card-custom gutter-b" style="height: 300px;">
                                                ...
                                                <div class="card-body d-flex flex-column p-0">
                                                    ...
                                                    <!--begin::Chart-->
                                                    <div id="kt_tiles_widget_17_chart" class="card-rounded-bottom"
                                        ...
                                        <div class="col-xl-4">
                                            ...
                                            <div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b"
                                                style="height: 300px; background-image: url(themes/metronic/theme/html/demo7/dist/assets/media/stock-600x600/img-15.jpg)">
                                                <!--begin::Body-->
                                                <div class="card-body">
                                                    <a href='#'
                                                        class="btn btn-link btn-link-dark-75 font-weight-bold font-size-h5">
                                                        Latest Products
                                                ...
                                                <div class="card-body d-flex flex-column">
                                                    <div
                                                        ...
                                                        <div class="mr-2">
                                                            ...
                                                            <div class="text-muted font-size-lg mt-2">
                                                                Create CRM Report for month - April 2017
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="pt-8">
                                                        <div
                                                            ...
                                                            <div class="text-muted font-weight-bold mr-2">Sale Progress
                                                            </div>
                                ...
                                <div class="col-xl-8">
                                    <div class="row h-50">
                                        <div class="col-xl-4">
                                            ...
                                            <div class="card card-custom gutter-b" style="height: 250px">
                                                ...
                                                <div class="card-body d-flex flex-column p-0">
                                                    ...
                                                    <!--begin::Chart-->
                                                    <div id="kt_tiles_widget_21_chart" class="card-rounded-bottom"
                                                        data-color="success" style="height: 100px"></div>
                                                    <!--end::Chart-->
                                                </div>
                                                <!--end::Body-->
                                            </div>
                                        ...
                                        <div class="col-xl-8">
                                            ...
                                            <div class="card card-custom bgi-no-repeat gutter-b"
                                                style="height: 250px; background-color: #1B283F; background-position: calc(100% + 0.5rem) calc(100% + 0.5rem); background-size: 100% auto; background-image: url(https://keenthemes.com/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/patterns/rhone-2.svg)">
                                                <!--begin::Body-->
                                                <div class="card-body">
                                    ...
                                    <div class="row h-50">
                                        <div class="col-xl-8">
                                            ...
                                            <div class="card card-custom gutter-b" style="height: 250px">
                                                ...
                                                <div class="card-body d-flex flex-column p-0">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="mr-2">
                                                                <a href="#"
                                                                    ...
                                                                    Reports</a>
                                                                <div
                                                                    class="text-muted font-size-lg font-weight-bold pt-2">
                                                    ...
                                                    <!--begin::Chart-->
                                                    <div id="kt_tiles_widget_23_chart" class="card-rounded-bottom"
                                                        data-color="primary" style="height: 100px"></div>
                                                    <!--end::Chart-->
                                                </div>
                                                <!--end::Body-->
                                            </div>
                                        ...
                                        <div class="col-xl-4">
                                            ...
                                            <div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b"
                                                style="height: 250px; background-image: url(themes/metronic/theme/html/demo7/dist/assets/media/stock-600x400/img-28.jpg)">
                                                <!--begin::Body-->
                                                <div class="card-body">
                                                    <a href='#'
                            ...
                            <div class="row">
                                <div class="col-xl-8">
                                    ...
                                    <div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b bg-primary"
                                        style="height: 250px; background-image: url(https://keenthemes.com/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/patterns/taieri.svg)">
                                        <div class="card-body d-flex">
                                            <div class="d-flex py-5 flex-column align-items-start flex-grow-1">
                                                <div class="flex-grow-1">
                                                    <a href="#"
                                                        class="text-white font-weight-bolder font-size-h3">Create CRM
                                                        Reports</a>
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="d-flex align-items-center mt-5">
                <div class="symbol symbol-100 mr-5">
                    <div class="symbol-label"
                        style="background-image:url('themes/metronic/theme/html/demo7/dist/assets/media/users/300_21.jpg')">
                    </div>
                        ...
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
                                <span class="svg-icon svg-icon-md svg-icon-danger">
                                    <!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/icons/Files/Selected-file.svg--><svg
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <polygon points="0 0 24 0 24 24 0 24" />
                        ...
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
                                <span class="svg-icon svg-icon-md svg-icon-primary">
                                    <!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/icons/Communication/Mail-opened.svg--><svg
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
        ...
        <div class="offcanvas-content">
            ...
            <div class="offcanvas-wrapper mb-5 scroll-pull">
                ...
                <div class="d-flex align-items-center justify-content-between py-8">
                    ...
                    <a href="#" class="symbol symbol-70 flex-shrink-0">
                        <img src="themes/metronic/theme/html/demo7/dist/assets/media/stock-600x400/img-1.jpg" title=""
                            alt="" />
                    </a>
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex align-items-center justify-content-between py-8">
                    ...
                    <a href="#" class="symbol symbol-70 flex-shrink-0">
                        <img src="themes/metronic/theme/html/demo7/dist/assets/media/stock-600x400/img-2.jpg" title=""
                            alt="" />
                    </a>
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex align-items-center justify-content-between py-8">
                    ...
                    <a href="#" class="symbol symbol-70 flex-shrink-0">
                        <img src="themes/metronic/theme/html/demo7/dist/assets/media/stock-600x400/img-3.jpg" title=""
                            alt="" />
                    </a>
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex align-items-center justify-content-between py-8">
                    ...
                    <a href="#" class="symbol symbol-70 flex-shrink-0">
                        <img src="themes/metronic/theme/html/demo7/dist/assets/media/stock-600x400/img-4.jpg" title=""
                            alt="" />
                    </a>
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex align-items-center justify-content-between py-8">
                    ...
                    <a href="#" class="symbol symbol-70 flex-shrink-0">
                        <img src="themes/metronic/theme/html/demo7/dist/assets/media/stock-600x400/img-8.jpg" title=""
                            alt="" />
                    </a>
                </div>
                <!--end::Item-->
                ...
                <div class="tab-pane fade show pt-3 pr-5 mr-n5 active" id="kt_quick_panel_logs" role="tabpanel">
                    ...
                    <div class="mb-15">
                        ...
                        <div class="d-flex align-items-center flex-wrap mb-5">
                            <div class="symbol symbol-50 symbol-light mr-5">
                                <span class="symbol-label">
                                    <img src="https://keenthemes.com/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/misc/005-bebo.svg"
                                        class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <div class="d-flex flex-column flex-grow-1 mr-2">
                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="symbol symbol-50 symbol-light mr-5">
                                <span class="symbol-label">
                                    <img src="https://keenthemes.com/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/misc/014-kickstarter.svg"
                                        class="h-50 align-self-center" alt="" />
                                </span>
                            </div>
                            <div class="d-flex flex-column flex-grow-1 mr-2">
                        ...
                        <div class="text-left flex-grow-1">
                            ...
                            <div class="dropdown dropdown-inline">
                                <button type="button" class="btn btn-clean btn-sm btn-icon btn-icon-md"
                                    ...
                                    <span class="svg-icon svg-icon-lg">
                                        <!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/icons/Communication/Add-user.svg--><svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <div class="d-flex flex-column mb-5 align-items-start">
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-circle symbol-40 mr-3">
                                            <img alt="Pic"
                                                src="themes/metronic/theme/html/demo7/dist/assets/media/users/300_12.jpg" />
                                        </div>
                                        <div>
                                            <a href="#"
                                ...
                                <div class="d-flex flex-column mb-5 align-items-end">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="symbol symbol-circle symbol-40 ml-3">
                                            <img alt="Pic"
                                                src="themes/metronic/theme/html/demo7/dist/assets/media/users/300_21.jpg" />
                                        </div>
                                    </div>
                                    <div
    ...
    <div id="kt_scrolltop" class="scrolltop">
        <span class="svg-icon">
            <!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/icons/Navigation/Up-2.svg--><svg
            ...
            <div class="offcanvas-wrapper mb-5 scroll-pull">
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo ">
                    ...
                    <div class="overlay-layer">
                        <a href="https://keenthemes.com/metronic/preview/demo1/features/widgets/tiles.html"
                            class="btn font-weight-bold btn-primary btn-shadow " target="_blank">Default</a>
                        <a href="https://keenthemes.com/metronic/preview/demo1/rtl/features/widgets/tiles.html"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo ">
                    ...
                    <div class="overlay-layer">
                        <a href="https://keenthemes.com/metronic/preview/demo2/features/widgets/tiles.html"
                            class="btn font-weight-bold btn-primary btn-shadow " target="_blank">Default</a>
                        <a href="https://keenthemes.com/metronic/preview/demo2/rtl/features/widgets/tiles.html"
                            class="btn font-weight-bold btn-light btn-shadow ml-2" target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo ">
                    ...
                    <div class="overlay-layer">
                        <a href="https://keenthemes.com/metronic/preview/demo3/features/widgets/tiles.html"
                            class="btn font-weight-bold btn-primary btn-shadow " target="_blank">Default</a>
                        <a href="https://keenthemes.com/metronic/preview/demo3/rtl/features/widgets/tiles.html"
                            class="btn font-weight-bold btn-light btn-shadow ml-2" target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo ">
                    ...
                    <div class="overlay-layer">
                        <a href="https://keenthemes.com/metronic/preview/demo4/features/widgets/tiles.html"
                            class="btn font-weight-bold btn-primary btn-shadow " target="_blank">Default</a>
                        <a href="https://keenthemes.com/metronic/preview/demo4/rtl/features/widgets/tiles.html"
                            class="btn font-weight-bold btn-light btn-shadow ml-2" target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo ">
                    ...
                    <div class="overlay-layer">
                        <a href="https://keenthemes.com/metronic/preview/demo5/features/widgets/tiles.html"
                            class="btn font-weight-bold btn-primary btn-shadow " target="_blank">Default</a>
                        <a href="https://keenthemes.com/metronic/preview/demo5/rtl/features/widgets/tiles.html"
                            class="btn font-weight-bold btn-light btn-shadow ml-2" target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo ">
                    ...
                    <div class="overlay-layer">
                        <a href="https://keenthemes.com/metronic/preview/demo6/features/widgets/tiles.html"
                            class="btn font-weight-bold btn-primary btn-shadow " target="_blank">Default</a>
                        <a href="https://keenthemes.com/metronic/preview/demo6/rtl/features/widgets/tiles.html"
                            class="btn font-weight-bold btn-light btn-shadow ml-2" target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active">
                    ...
                    <div class="overlay-layer">
                        <a href="tiles.html" class="btn font-weight-bold btn-primary btn-shadow "
                            target="_blank">Default</a>
                        <a href="rtl/features/widgets/tiles.html" class="btn font-weight-bold btn-light btn-shadow ml-2"
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo ">
                    ...
                    <div class="overlay-layer">
                        <a href="https://keenthemes.com/metronic/preview/demo8/features/widgets/tiles.html"
                            class="btn font-weight-bold btn-primary btn-shadow " target="_blank">Default</a>
                        <a href="https://keenthemes.com/metronic/preview/demo8/rtl/features/widgets/tiles.html"
                            class="btn font-weight-bold btn-light btn-shadow ml-2" target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo ">
                    ...
                    <div class="overlay-layer">
                        <a href="https://keenthemes.com/metronic/preview/demo9/features/widgets/tiles.html"
                            class="btn font-weight-bold btn-primary btn-shadow " target="_blank">Default</a>
                        <a href="https://keenthemes.com/metronic/preview/demo9/rtl/features/widgets/tiles.html"
                            class="btn font-weight-bold btn-light btn-shadow ml-2" target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo ">
                    ...
                    <div class="overlay-layer">
                        <a href="https://keenthemes.com/metronic/preview/demo10/features/widgets/tiles.html"
                            class="btn font-weight-bold btn-primary btn-shadow " target="_blank">Default</a>
                        <a href="https://keenthemes.com/metronic/preview/demo10/rtl/features/widgets/tiles.html"
                            class="btn font-weight-bold btn-light btn-shadow ml-2" target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo ">
                    ...
                    <div class="overlay-layer">
                        <a href="https://keenthemes.com/metronic/preview/demo11/features/widgets/tiles.html"
                            class="btn font-weight-bold btn-primary btn-shadow " target="_blank">Default</a>
                        <a href="https://keenthemes.com/metronic/preview/demo11/rtl/features/widgets/tiles.html"
                            class="btn font-weight-bold btn-light btn-shadow ml-2" target="_blank">RTL Version</a>
                    </div>
                </div>
...
<!-- Mirrored from keenthemes.com/metronic/preview/demo7/features/widgets/tiles.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Jun 2020 15:53:20 GMT -->
