...
<head>
        <meta charset="utf-8"/>
        <title>authentication  - Trade Capitalmax</title>
            ...
            <div class="login-form login-signin">
                ...
                <form class="form ajax"  >
                    ...
                    <div class="pb-13 pt-lg-0 pt-5">
                        ...
                        <span class="text-muted font-weight-bold font-size-h4">New Here? <a href="javascript:;" onclick=" $('.login-signup,.login-signin').fadeToggle()"  class="text-primary font-weight-bolder">Create an Account</a></span>
                    </div>
                    <!--begin::Title-->
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg" type="text" name="auth" autocomplete="off"/>
                    </div>
                    <!--end::Form group-->
                    ...
                    <div class="pb-lg-0 pb-5">
                        ...
                        <button type="button" class="btn btn-light-primary font-weight-bolder px-8 py-4 my-3 font-size-lg">
                            <span class="svg-icon svg-icon-md"><!--begin::Svg Icon | path:/metronic/themes/metronic/theme/html/demo7/dist/assets/media/svg/social-icons/google.svg--><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
    ...
    <path d="M10.1993 3.85336C12.1142 3.85336 13.406 4.66168 14.1425 5.33717L17.0207 2.59107C15.253 0.985496 12.9527 0 10.1993 0C6.2106 0 2.76588 2.23672 1.08887 5.49214L4.38626 7.99466C5.21352 5.59183 7.50242 3.85336 10.1993 3.85336Z" fill="#EB4335"/>
            ...
            <div class="login-form login-signup">
                ...
                <form class="form ajax" novalidate="validate" id="kt_login_signup_form">
                    ...
                    <!--begin::Form group-->
                    <div class="form-group">
                        <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6" type="text" placeholder="Fullname" name="new_user" autocomplete="off"/>
                    </div>
                    <!--end::Form group-->
                    ...
                    <div class="form-group d-flex flex-wrap pb-lg-0 pb-3">
                        ...
                        <button type="button" onclick=" $('.login-signup,.login-signin').fadeToggle()"  class="btn btn-light-primary font-weight-bolder font-size-h6 px-8 py-4 my-3">Cancel</button>
                    </div>
                    <!--end::Form group-->
                </form>
                <!--end::Form-->
