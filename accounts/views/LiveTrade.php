                                ...
                                <div class="col-xl-4">
                                    <div class="card card-custom gutter-b card-stretch">
                                            ...
                                            <div class="card-title font-weight-bolder">
                                                <div class="card-label">
                                                    ...
                                                    <div class="font-size-sm text-muted mt-2">
                                                        <?php echo mysqli_num_rows(mysqli_query($db,"select * from trans where user = '".$user['email']."'")); ?>
                                                        Transactions
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body p-0 d-flex flex-column">
                                            ...
                                            <div class="">
                                                <div class="col-xs-12">
                                                    <!-- Live Rates widget by Forextime.com -->
                                                    <script type="text/javascript"
                                                        src="//www.forextime.com/widget.js?type=live-rates&theme=light&p=&pt=no&l=&h=345&pairs=eurusdusdjpyeurgbpgbpusdeurchf&">
                                                    </script>
                                                </div> <!-- Live Rates widget by Forextime.com -->
                                                <!--end::Chart-->
                                                <div class="col-xs-12">
                                                    <!-- Profit Calculator widget by Forextime.com -->
                                                    <script type="text/javascript"
                                                        src="//www.forextime.com/widget.js?type=profit-calculator&theme=light&p=&pt=no&l=&h=390&">
                                                    </script> <!-- Profit Calculator widget by Forextime.com -->
                                                </div>
                                            </div>
                                        </div>
                                        <!--end::Body-->
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        ...
                                        <div class="card-body pt-2 pb-0">
                                            ...
                                            <coingecko-coin-compare-chart-widget
                                                coin-ids="bitcoin,ethereum,eos,ripple,litecoin" currency="usd"
