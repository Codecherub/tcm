                            ...
                            <div class="row mt-0 mt-lg-3">
                                ...
                                <div class="col-xl-4">
                                    ...
                                    <div class="card card-custom bgi-no-repeat gutter-b card-stretch"
                                        ...
                                        <div class="card-body">
                                            <div class="p-4">
                                                <h3 class="text-white font-weight-bolder my-7">Basic</h3>
                                                <p class="text-white font-size-lg mb-7">
                                                    <ul class="lx">
                                                        <li class="text-white"><i class="far fa-gem"></i> minimum $30 wallet bal</li>
                                                        <li class="text-white"><i class="far fa-gem"></i> 5% deposit bonus</li>
                                                        <li class="text-white"><i class="far fa-gem"></i> Weekly assets trading</li>
                                                        <li class="text-white"><i class="far fa-gem"></i> Auto trading</li>
                                                        <li class="text-white"><i class="far fa-gem"></i> 24hr support</li>
                                ...
                                <div class="col-xl-4">
                                    ...
                                    <div class="card card-custom bg-warning bgi-no-repeat gutter-b card-stretch"
                                        ...
                                        <div class="card-body">
                                            <div class="p-4">
                                                <h3 class="text-white font-weight-bolder my-7">Gold</h3>
                                                <p class="text-dark font-size-lg mb-7">
                                                    <ul class="lx">
                                                        <li class="text-dark"><i class="far fa-gem text-dark"></i> minimum $300 wallet bal</li>
                                                        <li class="text-dark"><i class="far fa-gem text-dark"></i> 15% deposit bonus</li>
                                                        <li class="text-dark"><i class="far fa-gem text-dark"></i> Weekly assets trading</li>
                                                        <li class="text-dark"><i class="far fa-gem text-dark"></i> Auto trading</li>
                                                        <li class="text-dark"><i class="far fa-gem text-dark"></i> 24hr support</li>
                                ...
                                <div class="col-xl-4">
                                    ...
                                    <div class="card card-custom bg-info bgi-no-repeat gutter-b card-stretch"
                                        ...
                                        <div class="card-body">
                                            <div class="p-4">
                                                <h3 class="text-white font-weight-bolder my-7">Platinum</h3>
                                                <p class="text-dark font-size-lg mb-7">
                                                    <ul class="lx">
                                                        <li class="text-white"><i class="far fa-gem"></i> minimum $500 wallet bal</li>
                                                        <li class="text-white"><i class="far fa-gem"></i> 37% deposit bonus</li>
                                                        <li class="text-white"><i class="far fa-gem"></i> Weekly assets trading</li>
                                                        <li class="text-white"><i class="far fa-gem"></i> manual/Auto trading</li>
                                                        <li class="text-white"><i class="far fa-gem"></i> 24hr support</li>
...
far fa-gem" style="font-size: 4em;">
                    </div>
